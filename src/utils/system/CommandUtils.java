...
import src.lib.interfaces.CommandHandler;
import src.utils.FileUtils;

/**
 * Utility class for handling user commands in the User Management system.
 * Implements the CommandHandler interface for command processing.
 */
public class CommandUtils implements CommandHandler {
     ...
     */
    @Override
    public boolean choose(Scanner scanner, String command, String[] parts) {
